...
const CategoryPage = () => {
  ...
  const categoryName = categorySlug ? categoryMap[categorySlug.toLowerCase()] || categorySlug : '';
        ...
        <section className="py-16 md:py-24">
          <div className="container">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-12">
              <div>
                <h2 className="text-3xl md:text-4xl font-display font-bold">{categoryName}</h2>
